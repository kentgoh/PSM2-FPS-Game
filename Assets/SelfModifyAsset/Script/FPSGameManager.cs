...
public class FPSGameManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        StartCoroutine("DisplayFingerCount");
    }
    ...
    IEnumerator DisplayFingerCount()
    {
        while (true)
        {
            leftFingerCountText.text = imageDetectionScript.rightFingerCount.ToString();
            rightFingerCountText.text = imageDetectionScript.leftFingerCount.ToString();
            yield return new WaitForSeconds(1f);
        }
